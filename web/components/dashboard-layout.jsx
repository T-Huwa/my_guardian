...
export default function DashboardLayout({ children, user }) {
  ...
  const Sidebar = () => (
    <div className="flex h-full flex-col">
      <div
        className={`flex h-16 items-center border-b px-4 ${theme.border} ${theme.primary}`}
      >
  ...
  return (
    <div className="flex h-screen bg-background">
      ...
      <div className="flex flex-1 flex-col overflow-hidden">
        <header
          className={`flex h-16 items-center border-b bg-card px-4 lg:px-6 ${theme.border}`}
        >
          <Sheet>
          ...
          {/* <div className="ml-auto flex items-center gap-2">
            <Link href="/dashboard/alerts/new">
              <Button
                size="sm"
                className={`${theme.primary} ${theme.hover} text-white`}
              >
